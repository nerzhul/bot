...
func TestPushHandler(t *testing.T) {
	...
	if !pushEvent.verifyEvent() {
		t.Error("pushEvent verification failed")
	}

	_, exists := pushFakeConfig[pushEvent.Project.PathWithNamespace]
	if !exists {
		t.Errorf("Channel not mapped to %s.", pushEvent.Project.PathWithNamespace)
	}
